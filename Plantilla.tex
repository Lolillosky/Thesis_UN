...
\newcommand{\johan}[1]{\textcolor{LimeGreen}{\textbf{Johan: #1}}}
\usepackage{hyperref}
\usepackage{parskip}
\usepackage{float} 
\usepackage{biblatex} 
...
\include{Chapters/MarketRisk}
\include{Chapters/CounterpartyRisk}
\include{Chapters/Bermudas}
\include{Chapters/MktFrictions}
\include{Chapters/SyntheticData}
...
% \bibliographystyle{formats/cna} CHANGE LUIS
% \phantomsection CHANGE LUIS
% \addcontentsline{toc}{chapter}{\bibname}% CHANGE LUIS
%% La bibliografía está en Plantilla.bib. Se recomienda usar un gestor de bibliografía ( p.ej. JABREF )
% \bibliography{formats/Plantilla} CHANGE LUIS

\printbibliography %CHANGE LUIS
